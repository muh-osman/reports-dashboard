...
import useGetAllMarketersMonthlyBalanceApi from "../../API/useGetAllMarketersMonthlyBalanceApi";
...
export default function Marketer() {
  ...
  const renderTabContent = () => {
    switch (value) {
      ...
      case 1:
        return <CouponImages code={marketerData?.code || "-"} percent={MarketerSettings?.codeDiscountPercentage || 0} />;
      case 2:
        return <HowWorks />;
      case 3:
          ...
          <div className={style.not_auth_box}>
            <div>
              <div className={style.not_auth_img}>
                <svg style={{ width: "100px", fill: "#174545" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <Button fullWidth sx={{ marginTop: "30px" }} variant="contained" component={Link} size="large" to={`${process.env.PUBLIC_URL}/login/?from=falak`}>
              {t("Marketer.login")}
            </Button>

            <Button fullWidth sx={{ marginTop: "16px" }} variant="outlined" component={Link} size="large" to={`${process.env.PUBLIC_URL}/signup/?from=falak`}>
              {t("Marketer.signup")}
            </Button>
          </div>
        </div>
            ...
            <div className={style.money_card_container}>
              <div className={style.money_card_header}>
                <div>
                  ...
                  <h1 dir="rtl">
                    <NumberFlow
                      value={Math.trunc(marketerData?.points || 0)}
                      duration={1500}
                      delay={0}
                      ease="outExpo"
                      formattingFn={(value) => Math.floor(value).toLocaleString()}
                    />{" "}
                    <span style={{ lineHeight: "1" }} className={style.rial}>
            ...
            <div className={style.person_card_container}>
              ...
              >
                ...
                >
                  <div className={style.terms_box} style={languageText === "ar" ? { textAlign: "right" } : { textAlign: "left" }}>
                    ...
                    <div>
                      <FormControlLabel control={<Checkbox required checked={true} disabled={true} />} label={t("Conditions.label")} />
                    </div>
              ...
              <div style={{ width: "100%" }}>
                ...
                <div className={style.button_box}>
                  ...
                  <Button fullWidth sx={{ width: "50%" }} variant="outlined" component={Link} to={`${process.env.PUBLIC_URL}/falak/history`}>
                    {t("Marketer.history")}
                  </Button>
                </div>
              </div>

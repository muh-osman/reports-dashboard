      ...
      <div className={style.not_auth_container}>
        <div className={style.not_auth_box}>
          <div>
            ...
            <h1>برنامج "فالك" للتسويق بالعمولة</h1>
            <p>
              هو منصة تتيح لك كمسوق فرصة ربح المال بسهولة من خلال الترويج لخدمات
              مركز كاشف لفحص السيارات عبر الإنترنت او من خلال التوصية المباشرة
              لدوائر المعارف والأصدقاء والمقربين.
            </p>
            <p>
              من خلال الانضمام إلى البرنامج، تحصل على "كود" تسويقي خاص بك
              للترويج لمنتجات الفحص، وعندما يقوم الأشخاص بزيارة مراكز كاشف لفحص
              السيارت والحصول على احد منتجات الفحص عبر "الكود"، تكسب عمولة على
              كل عملية فحص.
            </p>
            <p>

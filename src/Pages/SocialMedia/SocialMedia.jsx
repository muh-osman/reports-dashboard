...
import { Button, Container, Typography, Box, Stack, SvgIcon } from "@mui/material";
...
// Official Snapchat Icon (Font Awesome SVG)
...
const socialLinks = [
  {
    name: "Snapchat",
    icon: <SnapchatIcon />,
    url: "https://www.snapchat.com/add/cashif_sa",
    color: "#FFFC00",
    textColor: "#000",
  ...
  },
  {
    name: "Instagram",
    icon: <InstagramIcon />,
    url: "https://www.instagram.com/cashif_sa",
    color: "#E4405F",
  ...
  },
  {
    name: "TikTok",
    icon: <TikTokIcon />,
    url: "https://www.tiktok.com/@cashif_sa",
    color: "#000000",
  ...
  },
  {
    name: "YouTube",
    icon: <YouTubeIcon />,
    url: "https://www.youtube.com/@cashifcc",
    color: "#FF0000",
...
export default function SocialMedia() {
  return (
    <div className={style.container}>
      <Container maxWidth="xs" className={style.card}>
        ...
        <Stack spacing={2} className={style.buttonStack}>
          {socialLinks.map((social) => (
            <Button
              ...
              className={`${style.socialButton} ${social.className}`}
              sx={{
                backgroundColor: social.color,
                color: social.textColor || "#fff",
                "&:hover": {
                  backgroundColor: social.color,

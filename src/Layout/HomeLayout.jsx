  ...
  return (
    <div style={{ backgroundColor: "#f0f1f3" }}>
      ...
      <Zoom in={true}>
        ...
        >
          <WhatsAppIcon sx={{ color: "white", fontSize: { xs: 28, sm: 36 } }} />
        </Fab>
      </Zoom>

      {/* Floating Gift Button in bottom */}
      {/* <Zoom in={true}>
        <Fab
          color="primary"
          aria-label="whatsapp"
          sx={{
            ...
            display: "flex",
            position: "fixed",
            bottom: { xs: 164, sm: 100 },
            left: { xs: 16, sm: 32 },
            zIndex: 1000,
            backgroundColor: "#ffd53b", // WhatsApp green color
            "&:hover": {
              backgroundColor: "#ffc800", // Darker green on hover
            },
          }}
          onClick={() => navigate(`${process.env.PUBLIC_URL}/1`)}
        >
          <svg className={style.svg_icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      {/* <Zoom in={true}>
        <Fab
          ...
          sx={{
            ...
            // backgroundColor: "#ffd53b", // WhatsApp green color
            "&:hover": {
              backgroundColor: "#d33030", // Darker green on hover
            },
          }}
          onClick={() => navigate(`${process.env.PUBLIC_URL}/1`)}
        >
          <svg style={{ fill: "#ffc800", width: "32px", height: "32px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path d="M321.5 68.8C329.1 55.9 342.9 48 357.8 48l2.2 0c22.1 0 40 17.9 40 40s-17.9 40-40 40l-73.3 0 34.8-59.2zm-131 0l34.8 59.2-73.3 0c-22.1 0-40-17.9-40-40s17.9-40 40-40l2.2 0c14.9 0 28.8 7.9 36.3 20.8zm89.6-24.3l-24.1 41-24.1-41C215.7 16.9 186.1 0 154.2 0L152 0c-48.6 0-88 39.4-88 88 0 14.4 3.5 28 9.6 40L32 128c-17.7 0-32 14.3-32 32l0 32c0 17.7 14.3 32 32 32l448 0c17.7 0 32-14.3 32-32l0-32c0-17.7-14.3-32-32-32l-41.6 0c6.1-12 9.6-25.6 9.6-40 0-48.6-39.4-88-88-88l-2.2 0c-31.9 0-61.5 16.9-77.7 44.4zM480 272l-200 0 0 208 136 0c35.3 0 64-28.7 64-64l0-144zm-248 0l-200 0 0 144c0 35.3 28.7 64 64 64l136 0 0-208z" />
          </svg>
        </Fab>
      </Zoom> */}
